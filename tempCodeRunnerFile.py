...
MONGO_URI = f"mongodb+srv://{encoded_username}:{encoded_password}@cluster.mongodb.net/plant_disease_db?retryWrites=true&w=majority"
...
# Only proceed if collections are initialized
if not registrations_collection or not supplements_collection:
    print("MongoDB collections not initialized. Exiting...")
    exit(1)  # Stop the app if MongoDB connection or collections aren't ready
